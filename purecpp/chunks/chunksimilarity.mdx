...
To use **ChunkSimilarity**, you first need to install the `RagPUREAI_chuncks_clean` Python package:
...
**Example:**
```python
from RagPUREAI_chuncks_clean import ChunkSimilarity, EmbeddingModel
...
```python
from RagPUREAI_chuncks_clean import EmbeddingModel
