...
## Installation
To use **ChunkSimilarity**, you first need to install the `purecpp_chuncks_clean` Python package:
...
**Example:**
```python
from purecpp_chuncks_clean import ChunkSimilarity, EmbeddingModel
...
```python
from purecpp_chuncks_clean import EmbeddingModel
