...
To use the **MetadataRegexExtractor**, you first need to install the `RagPUREAI_extract` Python package.
...
```python
from RagPUREAI_meta import MetadataRegexExtractor
...
```python
from RagPUREAI_meta import Document
