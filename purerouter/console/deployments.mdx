...
### 3. Configuration
 ...
 model behavior with the following parameters:
...
After creating a deployment, you will receive a unique ID that identifies your specific model. This is the ID you will use to communicate directly with the deployment through the API.

![Deployment ID](../../images/id_deployments.png)

The Deployment ID is essential for:
- Making direct calls to the specific model
- Ensuring response consistency
- Accessing specialized or fine-tuned models
